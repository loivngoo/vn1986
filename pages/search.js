...
export default function Search(props) {
  ...
  const {
    query = query ?? SEARCH_TYPE.QUERY,
    category = category ?? SEARCH_TYPE.CATEGORY,
    brand = brand ?? SEARCH_TYPE.BRAND,
    price = price ?? SEARCH_TYPE.PRICE,
    rating = rating ?? SEARCH_TYPE.RATING,
    sort = sort ?? SEARCH_TYPE.FEATURED_SORT,
    page = 1,
  } = router.query;
